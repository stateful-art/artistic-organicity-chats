...
const Home = () => {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center p-4 bg-gray-800">
      <div className="w-full sm:w-1/2 xl:w-2/5">
        <div className="border-teal p-8 border-t-12 bg-yellow-400 mb-6 rounded-lg shadow-lg bg-white">
          <div className="mb-4">

            <label className="font-bold text-grey-darker block mt-4 mb-2">Email</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-center m-2">or
              </p> 
            <a
              onClick={(e) => {
                e.preventDefault()
              ...
              href={'/channels/1'}
              className="bg-black hover:bg-teal text-white py-2 px-4 rounded text-center transition duration-150 hover:text-black"
            >
              Sign up
            </a>
          </div>
